...
public class BinaryTree
{
    ...
    private int Count(Node NewNode)
    {
        ...
        return 1 + Count(NewNode.LeftNode) + Count(NewNode.RightNode);
    }

    public int CountBranch()
    {
        return this.root == null ? 0 : Count(this.root) - 1;
    }
}
...
namespace install
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine(tree.CountBranch());
        }
    }
}
